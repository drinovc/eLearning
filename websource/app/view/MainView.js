                            ...
                            items: [
                                {
                                    ...
                                    handler: function(button, e) {
                                        this.up('#mainView').getController().newSection();
                                    },
                                        ...
                                        items: [
                                            {
                                                xtype: 'menuitem',
                                                handler: function(item, e) {
                                                    this.up('#mainView').getController().setBackground();
                                                },
                                                text: 'Blank'
                                            },
                                            {
                                                xtype: 'menuitem',
                                                handler: function(item, e) {
                                                    this.up('#mainView').getController().setBackground('resources/images/background-0.jpg');
                                                },
                                                text: 'Background 0'
                                            },
                                            {
                                                xtype: 'menuitem',
                                                handler: function(item, e) {
                                                    this.up('#mainView').getController().setBackground('resources/images/background-1.jpg');
                                                },
                                                text: 'Background 1'
                                            },
                                            {
                                                xtype: 'menuitem',
                                                handler: function(item, e) {
                                                    this.up('#mainView').getController().setBackground('resources/images/background-2.jpg');
                                                },
                                                text: 'Background 2'
                                            },
                                            {
                                                xtype: 'menuitem',
                                                handler: function(item, e) {
                                                    this.up('#mainView').getController().setBackground('resources/images/background-3.jpg');
                                                },
                                                text: 'Background 3'
                                            },
                                            {
                                                xtype: 'menuitem',
                                                handler: function(item, e) {
                                                    this.up('#mainView').getController().setBackground('resources/images/background-4.jpg');
                                                },
                                                text: 'Background 4'
                                            },
                                            {
                                                xtype: 'menuitem',
                                                handler: function(item, e) {
                                                    this.up('#mainView').getController().setBackground('resources/images/background-5.jpg');
                                                },
                                                text: 'Background 5'
                                            }
                                        ]
